...
import ChapterAcccessForm from "./_component/chapter-access-form";
import ChapterVideoForm from "./_component/chapter-video-form";
import Banner from "@/components/banner";
import ChapterActions from "./_component/chapter-actions";

const ChapterDetail = async ({params}: {params: { courseId: string; chapterId: string }}) => {
    const { userId } = auth()
            ...
            <div className="grid gird-cols-1 md:grid-cols-2 gap-6 mt-16">
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        <ChapterAcccessForm chapter={chapter} />
                    </div>
                </div>
                <div>
                    <div className="flex items-center gap-x-2">
